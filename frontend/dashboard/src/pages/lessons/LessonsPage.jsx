                    ...
                    {filteredLessons.map(lesson => (
                        ...
                        >
                            <div className="lesson-card-header">
                                ...
                                <h3 className="lesson-title" title={lesson.group_name}>
                                    {lesson.group_name}
                                </h3>
                            ...
                            <div className="lesson-card-content">
                                <div className="lesson-details">
                                    <div className="lesson-detail-item">
                                        <span className="lesson-detail-label">Тема:</span>
                                        <span className="lesson-detail-value">{lesson.topic || '—'}</span>
                                    </div>
                                    <div className="lesson-detail-item">
                                ...
                                <div className="lesson-actions" onClick={(e) => e.stopPropagation()}>
                                    <RequireSubscription
                                        fallback={
                                            <button className="lesson-action-btn view-btn opacity-50 cursor-not-allowed" disabled title="Требуется подписка">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
